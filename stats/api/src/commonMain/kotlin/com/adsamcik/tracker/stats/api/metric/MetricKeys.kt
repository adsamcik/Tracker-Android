...
enum class MetricKey(val storageKey: String, private vararg val backingTables: String) {
	...
	ON_FOOT_ACTIVE_DAYS("on_foot_active_days", TABLE_SESSION_SEGMENT_NAME),
	CYCLING_ACTIVE_DAYS("cycling_active_days", TABLE_SESSION_SEGMENT_NAME),
	VEHICLE_ACTIVE_DAYS("vehicle_active_days", TABLE_SESSION_SEGMENT_NAME),
