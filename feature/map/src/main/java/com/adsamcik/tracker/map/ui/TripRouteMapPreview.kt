...
/**
 * Map-owned implementation supplied to feature consumers at the app composition root.
 */
object MapRoutePreviewRenderer : RoutePreviewRenderer {
	@Composable
	override fun Content(
		...
		TripRouteMapPreview(
			points = points.map { point -> LatLngModel(point.lat, point.lng) },
			modifier = modifier,
		)
	}
}
