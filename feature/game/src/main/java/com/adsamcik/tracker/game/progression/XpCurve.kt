 ...
 * | 10    | 948       | 4,275      |
 *
 * The mini-game unlock gates (Outrun L3, Territory L6, Zen Walk L9) read the
 * cached level in `player_profile`, which [PlayerProgressionRepository] derives
 * from the `xp_ledger` total via this curve.
 */
internal object XpCurve {
