...
class Release2024_1MigrationTest {
	...
	@Test
	fun `actual v10 binary migrates through Room and validates the complete v27 schema`() {
	...
	private companion object {
		...
		const val CURRENT_APP_DATABASE_VERSION = 27
		...
		val currentAppTables = listOf(
			...
			"source_coordinator_lease",
			"source_desired_plan",
			"source_event_session_binding",
			"source_event_wal",
			"location_projection_observation",
			"location_projection_point",
			"source_projection_checkpoint",
			"source_projection_failure",
			"source_projection_join_state",
			"source_projection_outbox",
			"source_projection_registration",
