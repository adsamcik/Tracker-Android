...
data class SourceDestinationOwnerEntity(
	...
	companion object {
		...
		const val OWNER_CONTAINED_ACTIVITY_SESSION_FACTS =
			"CONTAINED_ACTIVITY_SESSION_FACTS"
		...
		const val OWNER_CONTAINED_CELL_SESSION_FACTS = "CONTAINED_CELL_SESSION_FACTS"
		const val OWNER_WIFI_SESSION_FACTS = "WIFI_SESSION_FACTS"
		const val OWNER_CONTAINED_WIFI_SESSION_FACTS = "CONTAINED_WIFI_SESSION_FACTS"
		...
		const val ACTIVITY_FACT_PROJECTION_ID = "activity-session-facts"
		const val ACTIVITY_FACT_PROJECTION_VERSION = 1
		const val ACTIVITY_FACT_BINDING_GENERATION = 1L
