...
data class LegacyV27ProjectionTargetEntity(
	...
	companion object {
		...
		const val DISPOSITION_SUPPRESSED_STALE_CONTROL = "SUPPRESSED_STALE_CONTROL"
		const val DISPOSITION_SUPPRESSED_UNREGISTERED_OUTPUT = "SUPPRESSED_UNREGISTERED_OUTPUT"
		const val DISPOSITION_BRIDGED_TYPED_FACTS = "BRIDGED_TYPED_FACTS"
		const val DISPOSITION_BRIDGED_TYPED_FACTS_PARTIAL = "BRIDGED_TYPED_FACTS_PARTIAL"
		const val DISPOSITION_SUPPRESSED_UNWIRED_OUTPUT = "SUPPRESSED_UNWIRED_OUTPUT"
		const val DISPOSITION_LOCATION_SHADOW_RETAINED = "LOCATION_SHADOW_RETAINED"
		const val DISPOSITION_LOCATION_SHADOW_PARTIAL = "LOCATION_SHADOW_PARTIAL"
	}
}
