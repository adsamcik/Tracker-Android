...
import com.adsamcik.tracker.shared.model.pressure.portable.PORTABLE_PRESSURE_RUN_ORDER
import com.adsamcik.tracker.shared.model.pressure.portable.PORTABLE_PRESSURE_WINDOW_ORDER
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureAvailability
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureCoverage
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureDigest
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureEntryV1
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureIdentityKind
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureOpaqueIdentity
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureRunV1
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureSensorAccuracy
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureWindowClosure
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureWindowQualification
import com.adsamcik.tracker.shared.model.pressure.portable.PortablePressureWindowV1
import com.adsamcik.tracker.shared.model.pressure.portable.PressurePortableFormatV1
 ...
 */
object ImportedPressureLineageAuthenticator {
	...
	fun authenticate(
		...
		require(orderedHeaders.map { it.contentChecksum }.distinct().size == orderedHeaders.size) {
			"An identical Pressure entry must reuse its existing import revision"
		}
...
data class AuthenticatedImportedPressureLineage(
...
data class AuthenticatedImportedPressureRevision(
	val header: ImportedPressureEntryRevisionEntity,
	val entry: PortablePressureEntryV1,
)

enum class ImportedPressureLineageFailureReason {
...
class ImportedPressureLineageFailure(
...
@Suppress("LongMethod")
fun ImportedPressureWindowEntity.toPortablePressureWindow() = PortablePressureWindowV1(
