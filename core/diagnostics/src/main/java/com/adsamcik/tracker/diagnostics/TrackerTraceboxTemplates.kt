...
object TrackerTraceboxTemplates {
	...
	val ACTIVITY_CALLBACK_METADATA_UPDATE_FAILED =
		LogTemplate.of("Activity callback metadata update failed")
	...
	val ACTIVE_DATABASE_OPEN_RETRYABLE =
		LogTemplate.of("Active database open temporarily unavailable: reason {}")
	...
	val APPLICATION_STARTUP_BLOCKED =
		LogTemplate.of("Application tracking startup blocked: stage {}, failure code {}")
	val APPLICATION_STARTUP_RECONCILED =
		LogTemplate.of("Application startup reconciliation completed")
	val APPLICATION_STARTUP_RETRYABLE_FAILURE =
		LogTemplate.of("Application tracking startup retryable failure: stage {}, failure code {}")
	...
	val SOURCE_POLICY_OBSERVATION_FAILED = LogTemplate.of("SourcePolicy observation failed")
	...
	val TRACKING_DIAGNOSTIC_UNMETERED_EVENT = LogTemplate.of(
		"tracking_diagnostic_event source={} purpose={} pipeline_stage={} operation={} result={} reason={} lifecycle={} coarse_time_bucket={} scope_duration_bucket={}",
	)
	val TRACKING_DIAGNOSTIC_ENQUEUE_EVENT = LogTemplate.of(
		"tracking_diagnostic_event source={} purpose={} pipeline_stage={} operation={} result={} reason={} lifecycle={} coarse_time_bucket={} scope_duration_bucket={} encoded_envelope_size_bucket={} queue_backlog_bucket={}",
	)
	val TRACKING_DIAGNOSTIC_DRAIN_EVENT = LogTemplate.of(
		"tracking_diagnostic_event source={} purpose={} pipeline_stage={} operation={} result={} reason={} lifecycle={} coarse_time_bucket={} scope_duration_bucket={} drained_envelope_count_bucket={} remaining_envelope_backlog_bucket={}",
	)
	val TRACKING_DIAGNOSTIC_WRITE_BATCH_EVENT = LogTemplate.of(
		"tracking_diagnostic_event source={} purpose={} pipeline_stage={} operation={} result={} reason={} lifecycle={} coarse_time_bucket={} scope_duration_bucket={} persisted_envelope_count_bucket={}",
	)
	...
	val TRACKING_REBASE_ENQUEUE_FAILED =
		LogTemplate.of("Tracking rebase enqueue failed")
	val TRACKING_REDELIVERY_RESOLUTION_FAILED =
		LogTemplate.of("Tracking redelivery resolution failed")
	val TRACKING_RUNTIME_PERMISSION_RECONCILIATION_FAILED =
		LogTemplate.of("Tracking runtime permission reconciliation failed")
