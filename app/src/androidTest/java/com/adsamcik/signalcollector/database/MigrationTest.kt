...
class MigrationTest {
	...
	fun migrate2To3() {
		...
		db.execSQL("insert into location_data (id, time, lat, lon, alt, hor_acc, activity, confidence) values (4, '1544682291', 50.7036309, 18.995304, 39.2, 4.6, 3, 64)")
		...
		helper.runMigrationsAndValidate(TEST_DB, 2, true, MIGRATION_2_3).apply {
