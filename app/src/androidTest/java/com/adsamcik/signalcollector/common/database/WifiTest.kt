...
class WifiTest {
	...
	@Test
	fun testInsert() {
		val data1 = DatabaseWifiData("00:19:3b:99:e2:80", 50.123, 10.321, null, System.currentTimeMillis(), System.currentTimeMillis(), "Example", "[WPA2]", 2400, -80)
		val data2 = DatabaseWifiData("00:19:3b:99:e2:81", 51.234, 15.432, 300.0, System.currentTimeMillis(), System.currentTimeMillis(), "Example2", "[WPA2, WPA]", 5000, -90)
		...
		array.forEach { dwd ->
			...
			Assert.assertEquals(dwd.longitude, item.longitude, 0.00001)
			Assert.assertEquals(dwd.latitude, item.latitude, 0.00001)
