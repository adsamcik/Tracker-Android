...
public final class Network {
    public static final String URL_WEB = "http://signals.adsamcik.xyz/";
    ...
    public static final String URL_DATA_UPLOAD = URL_WEB + "upload";
    public static final String URL_TILES = URL_WEB + "tiles/";
