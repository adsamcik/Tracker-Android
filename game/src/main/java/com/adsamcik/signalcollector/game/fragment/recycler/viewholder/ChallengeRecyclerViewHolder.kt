...
class ChallengeRecyclerViewHolder(rootView: View, title: TextView, recycler: RecyclerView, layer: Int) : ListRecyclerViewHolder<ChallengeRecyclerData>(rootView, title, recycler, layer) {
