...
internal class StepsViewHolder(
	...
	override fun bind(data: StepsRecyclerData, styleController: StyleController) {
		...
		dailyStepsTitle.text = resources.getString(R.string.game_goals_steps_daily)
		dailyStepsText.text = data.stepsToday.formatReadable()
		weeklyStepsTitle.text = resources.getString(R.string.game_goals_steps_weekly)
		weeklyStepsText.text = data.stepsThisWeek.formatReadable()
	}
}
