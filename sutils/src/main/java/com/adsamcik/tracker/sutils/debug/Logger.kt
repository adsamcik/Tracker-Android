...
object Logger : CoroutineScope {
	...
	private var preferences: com.adsamcik.tracker.common.preferences.Preferences? = null
	...
	fun initialize(context: Context) {
		...
		preferences = com.adsamcik.tracker.common.preferences.Preferences.getPref(context)
