...
val SurfaceContainerLowestDark = Color(0xFF080C08)
val SurfaceContainerLowDark = Color(0xFF161A15)
val SurfaceContainerDark = Color(0xFF1E231D)
val SurfaceContainerHighDark = Color(0xFF2A302A)
val SurfaceContainerHighestDark = Color(0xFF353B34)
val SurfaceTintDark = Color(0xFF7BDA97)
val BackgroundDark = Color(0xFF0A0E0A)
